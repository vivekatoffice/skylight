...
```sh
docker build --platform=linux/amd64 --tag axoverlay2_airplane_tracking:1.0 --build-arg ARCH=aarch64 .

docker create --platform=linux/amd64 axoverlay2_airplane_tracking:1.0

docker cp 9c359d20d969eaba4f09ed7ac1dd551e69a1d286743762fda9f84481752c263f:/opt/app ./build
```
